...
class EffectComposer {
	...
	render( deltaTime ) {
		...
		// var currentXREnabled = this.renderer.xr.enabled;
...
class FullScreenQuad {
	...
	render( renderer ) {
		...
		// this._mesh.quaternion.copy(camera.quaternion.clone().negate())
		this._mesh.position.copy(camera.position)
		this._mesh.position.add(new THREE.Vector3(0,0,-1).applyQuaternion(camera.quaternion.clone()))
