...
import {THREE, RenderPass, EffectComposer, UnrealBloomPass, AfterimagePass} from '../post/three-defs.js';
...
class XRController extends entity.Component {
    ...
    onSessionStarted( session, context ){
        ...
        afterimagePass.uniforms[ 'damp' ].value = .7
		    this.composer_.addPass( afterimagePass );
